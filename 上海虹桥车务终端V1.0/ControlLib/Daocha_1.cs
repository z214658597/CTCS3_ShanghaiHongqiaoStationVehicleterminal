...
{ 
    public partial class Daocha_1 : UserControl
    {
        #region 定义事件
        ...
        {
            int m = 0;
            a[1] = new Point(cuxi, m / 2 + (this.Height - m) * 15 / 16);
            ...
            a[5] = new Point(this.Width * 4 / 16, m / 2 + (this.Height - m) * 13 / 16);
            a[6] = new Point(this.Width * 10 / 16, m / 2 + (this.Height - m) * 1 / 16);
            a[7] = new Point(this.Width * 16 / 16, m / 2 + (this.Height - m) * 1 / 16);
            line.Clear();
