...
namespace ctc
{
    public partial class chewu : Form
    {
        #region 链表——存储站场布置数据
        ...
        foreach (Control ct in this.Controls)
            {
                ...
                //1类道岔初始化
                else if (ct.Name.Contains("daocha_1_2") || ct.Name.Contains("daocha_1_3") || ct.Name.Contains("daocha_1_6") || ct.Name.Contains("daocha_1_8"))
                {
                ...
                //1类道岔初始化
                else if (ct.Name.Contains("daocha_1_5") || ct.Name.Contains("daocha_1_7") || ct.Name.Contains("daocha_1_10") || ct.Name.Contains("daocha_1_12"))
                {
        ...
        private void LSCSH()
        {
            ...
            //下行
            //@1下行5G向1G发车
            string key = "button_X5+button_SFJ+button_bljl";
            string value = "xinhaoji_X5|L#daocha_1_10|F|S%daocha_1_6|F|S%daocha_2_2_4|D|X|S#X2LQ|S%X3LQ|S%IBG|S";
            ht_lsb.Add(key, value);
            //下行5G向1G发车进路取消
            key = "button_X5+button_SFJ+button_zqx";
            value = "xinhaoji_X5|H#daocha_1_10|F|K%daocha_1_6|F|K%daocha_2_2_4|D|X|K#X2LQ|K%X3LQ|K%IBG|K";
            ht_lsb.Add(key, value);
            //@2下行5G向2G发车
            key = "button_X5+button_SJ+button_bljl";
            value = "xinhaoji_X5|L#daocha_1_10|F|S%daocha_1_6|F|S%daocha_2_2_4|F|X|S#S2JG|S%S1JG|S%IIBG|S";
            ht_lsb.Add(key, value);
            //下行5G向2G发车进路取消
            key = "button_X5+button_SJ+button_zqx";
            value = "xinhaoji_X5|H#daocha_1_10|F|K%daocha_1_6|F|K%daocha_2_2_4|F|X|K#S2JG|K%S1JG|K%IIBG|K";
            ht_lsb.Add(key, value);
            //@3下行3G侧线发车
            key = "button_X3+button_SFJ+button_bljl";
            value = "xinhaoji_X3|L#daocha_1_10|D|S%daocha_1_6|F|S%daocha_2_2_4|D|X|S#X2LQ|S%X3LQ|S%IBG|S";
            ht_lsb.Add(key, value);
            //下行3G侧线发车进路取消
            key = "button_X3+button_SFJ+button_zqx";
            value = "xinhaoji_X3|H#daocha_1_10|D|K%daocha_1_6|F|K%daocha_2_2_4|D|X|K#X2LQ|K%X3LQ|K%IBG|K";
            ht_lsb.Add(key, value);
            //@4下行3G向2G发车
            key = "button_X3+button_SJ+button_bljl";
            value = "xinhaoji_X3|L#daocha_1_10|D|S%daocha_1_6|F|S%daocha_2_2_4|F|X|S#S2JG|S%S1JG|S%IIBG|S";
            ht_lsb.Add(key, value);
            //下行3G向2G发车进路取消
            key = "button_X3+button_SJ+button_zqx";
            value = "xinhaoji_X3|H#daocha_1_10|D|K%daocha_1_6|F|K%daocha_2_2_4|F|X|K#S2JG|K%S1JG|K%IIBG|K";
            ht_lsb.Add(key, value);
            //@5下行正线1G发车
            key = "button_X1+button_SFJ+button_bljl";
            value = "xinhaoji_X1|L#daocha_1_6|D|S%daocha_2_2_4|D|X|S#X2LQ|S%X3LQ|S%IBG|S";
            ht_lsb.Add(key, value);
            //下行正线1G发车进路取消
            key = "button_X1+button_SFJ+button_zqx";
            value = "xinhaoji_X1|H#daocha_1_6|D|K%daocha_2_2_4|D|X|K#X2LQ|K%X3LQ|K%IBG|K";
            ht_lsb.Add(key, value);
            //@6下行正线1G向2G发车
            key = "button_X1+button_SJ+button_bljl";
            value = "xinhaoji_X1|L#daocha_1_6|D|S%daocha_2_2_4|F|X|S#S2JG|S%S1JG|S%IIBG|S";
            ht_lsb.Add(key, value);
            //下行正线1G向2G发车进路取消
            key = "button_X1+button_SJ+button_zqx";
            value = "xinhaoji_X1|H#daocha_1_6|D|K%daocha_2_2_4|F|X|K#S2JG|K%S1JG|K%IIBG|K";
            ht_lsb.Add(key, value);
            //@7下行正线2G发车
            key = "button_X2+button_SJ+button_bljl";
            value = "xinhaoji_X2|L#daocha_1_8|D|S%daocha_2_2_4|D|S|S#S2JG|S%S1JG|S%IIBG|S";
            ht_lsb.Add(key, value);
            //下行正线2G发车进路取消
            key = "button_X2+button_SJ+button_zqx";
            value = "xinhaoji_X2|H#daocha_1_8|D|K%daocha_2_2_4|D|S|K#S2JG|K%S1JG|K%IIBG|K";
            ht_lsb.Add(key, value);
            //@8下行侧线4G发车
            key = "button_X4+button_SJ+button_bljl";
            value = "xinhaoji_X4|L#daocha_1_12|D|S%daocha_1_8|F|S%daocha_2_2_4|D|S|S#S2JG|S%S1JG|S%IIBG|S";
            ht_lsb.Add(key, value);
            //下行侧线4G发车进路取消
            key = "button_X4+button_SJ+button_zqx";
            value = "xinhaoji_X4|H#daocha_1_12|D|K%daocha_1_8|F|K%daocha_2_2_4|D|S|K#S2JG|K%S1JG|K%IIBG|K";
            ht_lsb.Add(key, value);
            //@9下行侧线6G发车
            key = "button_X6+button_SJ+button_bljl";
            value = "xinhaoji_X6|L#daocha_1_12|F|S%daocha_1_8|F|S%daocha_2_2_4|D|S|S#S2JG|S%S1JG|S%IIBG|S";
            ht_lsb.Add(key, value);
            //下行侧线6G发车进路取消
            key = "button_X6+button_SJ+button_zqx";
            value = "xinhaoji_X6|H#daocha_1_12|F|K%daocha_1_8|F|K%daocha_2_2_4|D|S|K#S2JG|K%S1JG|K%IIBG|K";
            ht_lsb.Add(key, value);
            //////////////////////////////////////////////////////////////////////////////////////////////////////////
            //上行
            //@1上行1G正线接车
            key = "button_SFJ+button_X1+button_bljl";
            value = "xinhaoji_SF|U#daocha_1_6|D|S%daocha_2_2_4|D|X|S#X2LQ|S%X3LQ|S%IBG|S%G1|S";
            ht_lsb.Add(key, value);
            //上行1G正线接车进路取消
            key = "button_SFJ+button_X1+button_zqx";
            value = "xinhaoji_SF|H#daocha_1_6|D|K%daocha_2_2_4|D|X|K#X2LQ|K%X3LQ|K%IBG|K%G1|K";
            ht_lsb.Add(key, value);
            //@2上行3G侧线接车
            key = "button_SFJ+button_X3+button_bljl";
            value = "xinhaoji_SF|UU#daocha_2_2_4|D|X|S%daocha_1_6|F|S%daocha_1_10|D|S#X2LQ|S%X3LQ|S%IBG|S%G3|S";
            ht_lsb.Add(key, value);
            //上行3G接车取消
            key = "button_SFJ+button_X3+button_zqx";
            value = "xinhaoji_SF|H#daocha_2_2_4|D|X|K%daocha_1_6|F|K%daocha_1_10|D|K#X2LQ|K%X3LQ|K%IBG|K%G3|K";
            ht_lsb.Add(key, value);
            //@3上行5G侧线接车
            key = "button_SFJ+button_X5+button_bljl";
            value = "xinhaoji_SF|UU#daocha_2_2_4|D|X|S%daocha_1_6|F|S%daocha_1_10|F|S#X2LQ|S%X3LQ|S%IBG|S%G5|S";
            ht_lsb.Add(key, value);
            //上行5G侧线取消
            key = "button_SFJ+button_X5+button_zqx";
            value = "xinhaoji_SF|H#daocha_2_2_4|D|X|K%daocha_1_6|F|K%daocha_1_10|F|K#X2LQ|K%X3LQ|K%IBG|K%G5|K";
            ht_lsb.Add(key, value);
            //@4上行2G正线接车
            key = "button_SJ+button_X2+button_bljl";
            value = "xinhaoji_S|U#daocha_2_2_4|D|S|S%daocha_1_8|D|S#S2JG|S%S1JG|S%IIBG|S%G2|S";
            ht_lsb.Add(key, value);
            //上行2G正线接车进路取消
            key = "button_SJ+button_X2+button_zqx";
            value = "xinhaoji_S|H#daocha_2_2_4|D|S|K%daocha_1_8|D|K#S2JG|K%S1JG|K%IIBG|K%G2|K";
            ht_lsb.Add(key, value);
            //@5上行2G向1G正线接车
            key = "button_SJ+button_X1+button_bljl";
            value = "xinhaoji_S|U#daocha_1_6|D|S%daocha_2_2_4|F|S|S#S2JG|S%S1JG|S%IIBG|S%G1|S";
            ht_lsb.Add(key, value);
            //上行2G向1G正线接车取消
            key = "button_SJ+button_X1+button_zqx";
            value = "xinhaoji_S|H#daocha_1_6|D|K%daocha_2_2_4|F|S|K#S2JG|K%S1JG|K%IIBG|K%G1|K";
            ht_lsb.Add(key, value);
            //@6上行2G向3G接车
            key = "button_SJ+button_X3+button_bljl";
            value = "xinhaoji_S|UU#daocha_1_10|D|S%daocha_1_6|F|S%daocha_2_2_4|F|S|S#S2JG|S%S1JG|S%IIBG|S%G3|S";
            ht_lsb.Add(key, value);
            //上行2G向3G接车取消
            key = "button_SJ+button_X3+button_zqx";
            value = "xinhaoji_S|H#daocha_1_10|D|K%daocha_1_6|F|K%daocha_2_2_4|F|S|K#S2JG|K%S1JG|K%IIBG|K%G3|K";
            ht_lsb.Add(key, value);
            //@7上行2G向5G接车
            key = "button_SJ+button_X5+button_bljl";
            value = "xinhaoji_S|UU#daocha_1_10|F|S%daocha_1_6|F|S%daocha_2_2_4|F|S|S#S2JG|S%S1JG|S%IIBG|S%G5|S";
            ht_lsb.Add(key, value);
            //上行2G向5G接车取消
            key = "button_SJ+button_X5+button_zqx";
            value = "xinhaoji_S|H#daocha_1_10|F|K%daocha_1_6|F|K%daocha_2_2_4|F|S|K#S2JG|K%S1JG|K%IIBG|K%G5|K";
            ht_lsb.Add(key, value);
            //@8上行4G侧线接车
            key = "button_SJ+button_X4+button_bljl";
            value = "xinhaoji_S|UU#daocha_2_2_4|D|S|S%daocha_1_8|F|S%daocha_1_12|D|S#S2JG|S%S1JG|S%IIBG|S%G4|S";
            ht_lsb.Add(key, value);
            //上行4G侧线取消
            key = "button_SJ+button_X4+button_zqx";
            value = "xinhaoji_S|H#daocha_2_2_4|D|S|K%daocha_1_8|F|K%daocha_1_12|D|K#S2JG|K%S1JG|K%IIBG|K%G4|K";
            ht_lsb.Add(key, value);
            //@9上行6G侧线接车
            key = "button_SJ+button_X6+button_bljl";
            value = "xinhaoji_S|UU#daocha_2_2_4|D|S|S%daocha_1_8|F|S%daocha_1_12|F|S#S2JG|S%S1JG|S%IIBG|S%G6|S";
            ht_lsb.Add(key, value);
            //上行6G侧线取消
            key = "button_SJ+button_X6+button_zqx";
            value = "xinhaoji_S|H#daocha_2_2_4|D|S|K%daocha_1_8|F|K%daocha_1_12|F|K#S2JG|K%S1JG|K%IIBG|K%G6|K";
            ht_lsb.Add(key, value);
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////            
            #endregion
        }
             ...
             if (dc != "")
             {
                 ...
                 foreach (string d in dcs)
                 {
                     ...
                     if (d.Contains("daocha_1_10"))
                     {
                         ...
                         if (((Daocha_1_1)ht_DC_1[name]).定反位 == ControlLib.Daocha_1_1.DingFan.定位)
                         {
                             Graphics c = Graphics.FromImage(button_Daocha10.BackgroundImage);
                             c.Clear(Color.ForestGreen);
                             button_Daocha10.Refresh();
                         }
                         else
                         {
                             Graphics c = Graphics.FromImage(button_Daocha10.BackgroundImage);
                     ...
                     if (d.Contains("daocha_1_12"))
                     {
                         ...
                         if (((Daocha_1_1)ht_DC_1[name]).定反位 == ControlLib.Daocha_1_1.DingFan.定位)
                         {
                             Graphics c = Graphics.FromImage(button_Daocha12.BackgroundImage);
                             c.Clear(Color.ForestGreen);
                             button_Daocha12.Refresh();
                         }
                         else
                         {
                             Graphics c = Graphics.FromImage(button_Daocha12.BackgroundImage);
                     ...
                     if (d.Contains("daocha_2_2_4"))
                     {
                         ...
                         {
                             Graphics c = Graphics.FromImage(button_Daocha2_4.BackgroundImage);
                             c.Clear(Color.ForestGreen);
                             button_Daocha2_4.Refresh();
                         }
                         else
                         {
                             Graphics c = Graphics.FromImage(button_Daocha2_4.BackgroundImage);
         ...
         private bool jinlu_zy_jc(string info, object sender)
         {
             ...
             if (dc != "")
             {
                 ...
                 foreach (string d in dcs)
                 {
                     ...
                     if (d.Contains("daocha_1_2") || d.Contains("daocha_1_3") || d.Contains("daocha_1_6") || d.Contains("daocha_1_8"))
                     {
                         string[] st = d.Split('|');
                         string name = st[0];
                         string df = st[1];
                     ...
                     if (d.Contains("daocha_1_5") || d.Contains("daocha_1_7") || d.Contains("daocha_1_10") || d.Contains("daocha_1_12"))
                     {
                         string[] st = d.Split('|');
                         string name = st[0];
                         string df = st[1];
        ...
        #region 进路标记
         ...
         private void jinlu_pailie(string jinlu_xinxi)
         {
             foreach (DictionaryEntry jinlu in ht_jlxx)
             {
                 ...
                 {
                     if ((jinlu_xinxi.Split('+')[0] == "button_XJ") || (jinlu_xinxi.Split('+')[0] == "button_XFJ") || (jinlu_xinxi.Split('+')[0] == "button_X3") || (jinlu_xinxi.Split('+')[0] == "button_X1") || (jinlu_xinxi.Split('+')[0] == "button_X2") || (jinlu_xinxi.Split('+')[0] == "button_X4") || (jinlu_xinxi.Split('+')[0] == "button_X6") || (jinlu_xinxi.Split('+')[0] == "button_X8"))
                     {
                     ...
                     if ((jinlu_xinxi.Split('+')[0] == "button_SJ") || (jinlu_xinxi.Split('+')[0] == "button_SFJ") || (jinlu_xinxi.Split('+')[0] == "button_S3") || (jinlu_xinxi.Split('+')[0] == "button_S1") || (jinlu_xinxi.Split('+')[0] == "button_S2") || (jinlu_xinxi.Split('+')[0] == "button_S4") || (jinlu_xinxi.Split('+')[0] == "button_S6") || (jinlu_xinxi.Split('+')[0] == "button_S8"))
                     {
        ...
        private void daocha_1_5_Custom(object sender, Daocha_1_1.CustomEventArgs e)
        {
            if (e.Flag)
            {
                Graphics c = Graphics.FromImage(button_Daocha5.BackgroundImage);
        ...
        private void daocha_1_7_Custom(object sender, Daocha_1_1.CustomEventArgs e)
        {
            if (e.Flag)
            {
                Graphics c = Graphics.FromImage(button_Daocha7.BackgroundImage);
        ...
        private void daocha_1_10_Custom(object sender, Daocha_1_1.CustomEventArgs e)
        {
            if (e.Flag)
            {
                Graphics c = Graphics.FromImage(button_Daocha10.BackgroundImage);
        ...
        private void daocha_1_6_Custom(object sender, Daocha_1.CustomEventArgs e)
        {
            if (e.Flag)
            {
                Graphics c = Graphics.FromImage(button_Daocha6.BackgroundImage);
        ...
        private void daocha_1_8_Custom(object sender, Daocha_1.CustomEventArgs e)
        {
            if (e.Flag)
            {
                Graphics c = Graphics.FromImage(button_Daocha8.BackgroundImage);
        ...
        private void daocha_1_12_Custom(object sender, Daocha_1_1.CustomEventArgs e)
        {
            if (e.Flag)
            {
                Graphics c = Graphics.FromImage(button_Daocha12.BackgroundImage);
            ...
            if (ZCXL[t]!= null)
            {
                    ...
                    if (((Xinhaoji2)(ht_zc[ZCXL[0]])).X_flag != 5)
                    {
                        ...
                        else if (ZCXL[t].Contains("daocha_1"))
                        {
                            ...
                            else if (ZCXL[t].Contains("daocha_1_6"))
                            {
                                ((Daocha_1)ht_DC_1[ZCXL[t]]).锁闭状态 = ControlLib.Daocha_1.STATE.占用;
                                //车次号操作
                                if (((Daocha_1)ht_DC_1[ZCXL[t]]).定反位 == ControlLib.Daocha_1.DingFan.定位)
                            ...
                            else if (ZCXL[t].Contains("daocha_1_10") || ZCXL[t].Contains("daocha_1_12"))
                            {
            ...
            if (ZCXL[t] == null)
                { 
                    ...
                    for (k=1; k<t-1; k++)
                    {
                        ...
                        {
                            if (ZCXL[k].Contains("daocha_1_6") || ZCXL[k].Contains("daocha_1_8"))
                                ((Daocha_1)ht_DC_1[ZCXL[k]]).锁闭状态 = ControlLib.Daocha_1.STATE.空闲;
                            else if(ZCXL[k].Contains("daocha_1_10") || ZCXL[k].Contains("daocha_1_12"))
        ...
        private void 更新列表_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                {
                    jiefa = dr.GetString(dr.GetOrdinal("接发车"));
